...
<head>
    ...
    <style>
        body {
            background: linear-gradient(135deg,rgb(22, 41, 105) 0%,rgb(25, 62, 99) 100%);
            min-height: 100vh;
        }
        .mesa-btn {
            width: 160px;
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item"><a href="menu.php" class="btn btn-outline-light me-2">Menu</a></li>
            ...
            <div class="col-lg-10">
                <div class="reservar-card p-4">
                    <h2 class="main-title mb-4 text-center">
                        <?php if ($usuario !== ""): ?>
                            Bienvenidos reserve su mesa por favor, <?php echo htmlspecialchars($usuario); ?>
                        <?php else: ?>
                            Bienvenidos reserve su mesa por favor
                        <?php endif; ?>
                    </h2>
                    ...
                    <?php if (isset($_SESSION["reservada"])): ?>
                        <div class="alert alert-success text-center">
                            ...
                            <strong>Por su reserva es gratis</strong>
                        </div>
                            ...
                            <?php if (isset($_POST["mesa"]) && $_POST["mesa"] == $i && isset($_POST["cancelar"])): ?>
                                ...
                                <form method="POST" action="">
                                    ...
                                    <div class="text-center">
                                        <p>¿Cancelar reserva de la Mesa <?php echo $i; ?>?</p>
                                ...
                                <form method="POST" action="">
                                    ...
                                    <?php if ($reservadaPorUsuario): ?>
                                        ...
                                        <button type="submit" class="mesa-btn btn-danger">
                                            ...
                                            <div class="mesa-precio">S/ <?php echo $precioPlato; ?></div>
                                        </button>
                                    <?php elseif ($ocupada): ?>
