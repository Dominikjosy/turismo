...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Precio: 45 soles</h5>
            ...
            <div class="col">
                <div class="card h-100">
                    <a href="reservar.php?restaurante=sunampe&plato=Tacu%20Tacu%20con%20Lomo">
                        <img src="img/lomo.jpg" class="card-img-top" alt="Tacu Tacu">
                    </a>
                    <div class="card-body">
                        <h5 class="card-title">Lomo Saltado</h5>
                          <h5 class="card-title">Precio: 35 soles</h5>
                        <p class="card-text">Una fusión de sabor criollo.</p>
                        <a href="reservar.php?restaurante=sunampe&plato=Tacu%20Tacu%20con%20Lomo" class="btn btn-primary w-100 mt-2">Reservar en Sunampe</a>
                    </div>
                </div>
            </div>
        </div>
