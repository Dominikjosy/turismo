...
<html lang="es">
  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav me-auto">
            ...
            <li class="nav-item">
              <a href="menu.php" class="btn btn-outline-light"><i class="bi bi-list"></i> Menu</a>
            </li>
            <li class="nav-item">
    ...
    <div class="container text-center">
      <h1 class="main-title mb-3">Bienvenidos a nuestra Cadena de Restaurantes - Chincha</h1>
      <p class="lead mb-5">Disfruta de la mejor experiencia gastronómica con nosotros en nuestra provincia.</p>
      <div class="row g-4">
        <div class="col-md-4">
